...
{
    /// <summary>
    /// The interface for chunk stream creation functionality
    /// </summary>
    public interface IChunkStreamCreator
    {
        /// <summary>
        ...
        /// This method assumes that textStreamReader != null and that chunkSize > 0.
        /// </remarks>
        ...
        IEnumerable<List<int>> CreateIntegerChunkGenerator(StreamReader textStreamReader, int chunkSize);
    }
}
